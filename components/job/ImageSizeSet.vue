  ...
  <div>
    ...
    <div class="image-size">
      <el-radio-group :value="scale" class="radio-group" size="mini" @input="scaleClick">
        <el-radio-button
          ...
          :label="size.value"
          class="radio-item"
          v-track-label="$commonTrackLabel(activeJob + '_' + 'enlarge_' + size.value)"
        >
          <!-- <span></span> -->
          {{ size.label }}
        </el-radio-button>
    ...
    <div v-if="canCustomize" class="custom-size">
      <div
        ...
        v-track-label="$commonTrackLabel(activeJob + 'enlarge_customize')"
      >
    ...
    methods: {
      ...
      customSize() {
        ...
        this.changeConfigForParent({
          isCustomize: true,
          scale: 4,
          width: Number(this.customImageWidth),
          height: Number(this.customImageHeight),
        })
      },
      changeEnlarge(value) {
