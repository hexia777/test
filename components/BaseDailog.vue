<template>
  <div class="mask base" v-if="show">
    <div class="con-login">
      <div class="container">
        <template v-if="show">
          <div class="box">
            <div class="top">
              <div v-html="titleText" class="quicksand title"></div>
            </div>
            <div class="bot">
              <el-button class="cancel" v-show="showCancel" round @click="cancel">{{ cancelText }}</el-button>
              <el-button class="yes" type="primary" round @click="confirm">
                {{ yesText }}
              </el-button>
            </div>
          </div>
...
<style lang="less" scoped>
  ...
  /deep/ .bot {
    ...
    .yes {
      background-color: rgb(253, 65, 88);

      &:hover {
        background-color: rgb(251, 107, 124);
      }
    }
  }
